...
%%
function [b, IS_SET]=match_east(b, WHICH_FACE, IS_SET, i, ii)
%%
...
elseif WHICH_FACE==4
   FACE='WEST';    
                ...
                IS_SET(i,2)=1;
                b(i).PATCHTITLE(b(1).NUM_PATCH(i)) = {['PERIODIC - EAST - MATCHES WITH ',FACE,' ON BLOCK ', num2str(ii)]};
                b(i).PATCHTYPE(b(1).NUM_PATCH(i)) = 'P';
                b(i).IPATCHS(b(1).NUM_PATCH(i)) = b(i).NI; 
