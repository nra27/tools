...
for i = 1:NBLOCKIN,
    ...
    for j = 1:b(i).NPATCH,
       ...
       % CARD 51
       fprintf(fid,'%2.0f %2.0f %2.0f %2.0f %2.0f %2.0f \n',b(i).IPATCHS(j), b(i).IPATCHE(j), b(i).JPATCHS(j), b(i).JPATCHE(j), b(i).KPATCHS(j), b(i).KPATCHE(j)) 
    ...
    % CARD 59
    fprintf(fid,'%2.0f %2.0f %2.0f %2.0f %2.0f %2.0f %2.0f %2.0f %2.0f %2.0f %2.0f %2.0f \n',b(i).RPMBLOCK, b(i).FMGRID, b(i).XLLIM, ... 
        b(i).NSMALL_BLOCK, b(i).NBIG_BLOCK,b(i).ITRANS,b(i).JTRANS, b(i).KTRANS, b(i).FREE_TURB, b(i).XLLIM_FREE, b(i).IF_NOSHEAR,b(i).MIXL_TYPE)
