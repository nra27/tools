...
%%
function [b, IS_SET]=match_north(b, WHICH_FACE, IS_SET, i, ii)
%%
...
elseif WHICH_FACE==4
   FACE='WEST';    
                ...
                IS_SET(i,1)=1;
                b(i).PATCHTITLE(b(1).NUM_PATCH(i)) = {['PERIODIC - SOUTH - MATCHES WITH ',FACE,' ON BLOCK ', num2str(ii)]};
                b(i).PATCHTYPE(b(1).NUM_PATCH(i)) = 'P';
                b(i).IPATCHS(b(1).NUM_PATCH(i)) = 1; 
                b(i).IPATCHE(b(1).NUM_PATCH(i)) = b(i).NI; 
                b(i).JPATCHS(b(1).NUM_PATCH(i)) = b(i).NJ; 
