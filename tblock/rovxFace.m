...
for n = 1:1:grid.nblocks,
    ...
    surf(squeeze(x([1:skip:im],1,[1:skip:km])), ...
         ...
         squeeze(z([1:skip:end],1,[1:skip:km])), ...
         squeeze(var([1:skip:end],1,[1:skip:km])))
    ...
    % k = 1 face
    surf(squeeze(x([1:skip:im],[1:skip:jm],1)),squeeze(y([1:skip:im],[1:skip:jm],1)),squeeze(z([1:skip:end],[1:skip:jm],1)),squeeze(flow.block(n).rovx(1,[1:skip:jm],[1:skip:km])))
