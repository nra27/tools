...
function BlockFaceViewer(grid,flow,skip)
...
for n = 1:1:grid.nblocks,
    ...
    % i = 1 face
    surf(squeeze(x(1,[1:skip:jm],[1:skip:km])),squeeze(y(1,[1:skip:jm],[1:skip:km])),squeeze(z(1,[1:skip:jm],[1:skip:km])),squeeze(flow.block(n).ro(1,[1:skip:jm],[1:skip:km])))
    hold on 
    surf(squeeze(x(1,[1:skip:jm],[1:skip:km]))',squeeze(y(1,[1:skip:jm],[1:skip:km]))',squeeze(z(1,[1:skip:jm],[1:skip:km]))',clr(n))
