...
for k = [2 4 6 10 12 14 18 20 22 26 28 30 36 38 42 44 46 50 52 54 58 60 62 66];%[40 48 56 64], %[1 16], %1:3:66,
    ...
    load(['D:\hydra\grid_2.2\padram\Plot3D_coords_UH_' num2str(k)])
    ...
    save(['D:\hydra\grid_2.2\padram\ADF_coords_UH_' num2str(k)],'x','y','z','index')
    ...
    % Load the Plot3D coords
    load(['D:\hydra\grid_2.2\padram\Plot3D_coords_LH_' num2str(k)])
    ...
    % Save the index to the file
    save(['D:\hydra\grid_2.2\padram\ADF_coords_LH_' num2str(k)],'x','y','z','index')
