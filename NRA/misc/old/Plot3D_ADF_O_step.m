...
for k = [6:2:68 80:2:142],
    ...
    load(['D:\hydra\grid_2.2.step\post\Plot3D\Plot3D_coords_O_plain_' num2str(k)])
    ...
    save(['D:\hydra\grid_2.2.step\post\ADF\ADF_coords_O_' num2str(k)],'x','y','z','index')
