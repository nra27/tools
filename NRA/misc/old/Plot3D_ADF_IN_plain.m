...
for k = 20:2:34,
    ...
    load(['D:\hydra\grid_2.2\post\Plot3D\Plot3D_coords_IN_plain_' num2str(k)])
           
    for i = 1:91,
        for j = 1:100,
            
            % Display progress
            disp(['Inlet plane ' num2str(k) ' point: i = ' num2str(i) ' of 91, j = ' num2str(j) ' of 100']);  
    ...
    save(['D:\hydra\grid_2.2\post\ADF\ADF_coords_IN_plain_' num2str(k)],'x','y','z','index')
