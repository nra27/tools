...
for i=1:144,Q_dot_temp(i,:) = Qdot(145-i,:);end
Qdot = Q_dot_temp;
...
for n = 1:8,
    ...
    % CFD
    eval(['h = plot(x_rev' num2str(n) '/0.277*360/(2*pi)+1.1,q_dot_' num2str(n) ');'])
    set(h,'color','red')
    grid on
    hold on
    a = axis; 
