...
eval(['q_dot_' num2str(i) '_rad = [q_dot_spline; q_dot_spline; q_dot_spline;];'])
...
for n = 1:8,
    ...
    % CFD
    eval(['h = plot(x_' num2str(n) '/0.277*360/(2*pi)+1.1,q_dot_' num2str(n) '_rad);'])
