function [stab_cruise_clr,stab_MTO_clr,worst_decel_clr,worst_accel_clr] = func_closure_mm_stage6_new(dfact,cfact)
...
Xd_idle = 1.2298;
Xc_idle = 1.106;
casing_delay_idle = 4; drum_delay_idle = casing_delay_idle;

tau_casing_accel = 9; % s
tau_drum_accel = 90;
Xd_accel=0.09566;
Xc_accel=0.1265;

tau_casing_decel = 27; % s
tau_drum_decel = 485; 
Xd_decel=0.5124;
Xc_decel=1.0555;

tau_drum_cruise = 176;
tau_casing_cruise = 10;
Xd_cruise=0.2199;
Xc_cruise=0.382;
...
plot(t,clearance/22*100,'k','linewidth',lw); 
grid on 
hold on
