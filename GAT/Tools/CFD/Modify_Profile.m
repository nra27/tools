function Modify_Profile(old_filename,new_filename,offset,step);
%
% Modify_Profile(old_filename,new_filename,offset,step)
% A function to modify a blade definition file with 
% a given profile.
