function [D,file_bytes,machine_bytes,tokenized_data_type,file_format,machine_format,error_return] = ADFI_Evaluate_Datatype(file_index,data_type,D);
%
...
while strcmp(data_type_string(str_position),' ') == 0
	...
	switch data_type_string(str_position:str_position+1)
		...
		case 'I8'
			...
			size_machine = D.Machine_Sizes(machine_number,8);
