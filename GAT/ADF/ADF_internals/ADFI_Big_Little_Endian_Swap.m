function [D,to_data,error_return] = ADFI_Big_Little_Endian_Swap(from_format,from_os_size,to_format,to_os_size,data_type,delta_from_bytes,delta_to_bytes,from_data,D);
%
% [D,to_data,error_return] = ADFI_Big_Little_Endian_Swap(from_format,from_os_size,to_format,to_os_size,data_type,delta_from_bytes,delta_to_bytes,from_data,D)
%
% D - Delcaration space
...
if strcmp(from_os_size,to_os_size) ~= 1 | delta_to_bytes ~= delta_from_bytes
    error_return = 42;
    return
end
