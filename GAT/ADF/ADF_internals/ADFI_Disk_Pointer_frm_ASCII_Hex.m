function [D,block_offset,error_return] = ADFI_Disk_Pointer_frm_ASCII_Hex(block,offset,D);
%
% [block_offset,error_return] = ADFI_Disk_Pointer_frm_ASCII_Hex(block,offset,D)
%
