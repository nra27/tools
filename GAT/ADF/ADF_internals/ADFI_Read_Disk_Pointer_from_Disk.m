function [D,block_and_offset,error_return] = ADFI_Read_Disk_Pointer_from_Disk(file_index,file_block,block_offset,D);
%
% [block_offset,error_return] = ADFI_Read_Disk_Pointer_from_Disk(file_index,file_block,file_offset,D)
%
...
[D,block_and_offset,error_return] = ADFI_Disk_Pointer_from_ASCII_Hex(disk_block_offset(1:8),disk_block_offset(9:12),D);
if error_return ~= -1
    return
end