function [D,to_data,error_return] = ADFI_Big_Endian_32_Swap_64(from_format,from_os_size,to_format,to_os_size,data_type,delta_from_bytes,delta_to_bytes,from_data,D);
%
% [D,to_data,error_return] = ADFI_Big_Endian_32_Swap_64(from_format,from_os_size,to_format,to_os_size,data_type,delta_from_bytes,delta_to_bytes,from_data,D)
%
% D - Delcaration space
...
elseif delta_from_bytes < delta_to_bytes
    switch data_type
        case 'I8'
            if bitand(double(from_data(1)),128) == 128 % 2s complement negative
